...
class _SettingState extends State<Setting> {
  ...
  void get() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // Call setState to update the UI after the async operation completes
      setState(() {
        prefs = prefsInstance;
      });
    });
        ...
        child:  Column(
          children: [
            Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
              ...
              Text( localization.getLocaleData.setting.toString(),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                 Text(localization.getLocaleData.application.toString(),style:  MyTextTheme.largeBCN.copyWith(
                  color:
                  themeChange.darkTheme == false
                      ? Colors.black87
                      : AppColor.white,),),
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 10),
                         Expanded(
                           child: Text(localization.getLocaleData.darkMode.toString(),style:  MyTextTheme.mediumGCN.copyWith(
                            color:
                            themeChange.darkTheme == false
                                ? Colors.black87
                                : AppColor.white,),),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 10),
                        Text('${localization.getLocaleData.language} ' ,
                        ...
                        prefs==null? SizedBox(): Text(" ( "+
                            (prefs!.getString('lang')=='2'? 'Hindi':prefs!.getString('lang')=='3'?
                            'Arabic':'English' )+' )'
                          ,style:  MyTextTheme.mediumGCN.copyWith(
                              color:
                              themeChange.darkTheme == false
