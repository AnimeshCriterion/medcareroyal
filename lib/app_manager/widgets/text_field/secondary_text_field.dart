...
import 'package:medvantage_patient/app_manager/widgets/text_field/secondary_text_field_util.dart';
...
class SecondaryTextField extends StatelessWidget {
  ...
  const SecondaryTextField({Key? key, this.hintText, this.controller,
    this.validator,
    this.prefixIcon,
    this.suffixIcon,
    this.maxLength,
      ...
      TextFormField(
          ...
          decoration: decoration??InputDecoration(
            ...
            focusedBorder:  border??OutlineInputBorder(
              borderRadius: const BorderRadius.all(Radius.circular(SecondaryTextFieldUtil.border)),
            ...
            enabledBorder:  border?? OutlineInputBorder(
              borderRadius: const BorderRadius.all(Radius.circular(SecondaryTextFieldUtil.border)),
              borderSide: BorderSide(
                  color: borderColor??SecondaryTextFieldUtil.borderColor,
                  width: 1
              ),
            ),
